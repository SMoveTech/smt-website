...
module.exports = {
  ...
  projects: [
    // ── SMO ──────────────────────────────────────────────────────────────────
    {
      ...
      docs: [
        { id: 'smo-tech-arch', title: 'Technical Architecture v2', type: 'html', file: 'smo-technical-architecture.html', note: 'Full system architecture — stack, 35-table DB, 258 APIs, 10 core workflows, AI, security', review: { status: 'current', reviewedOn: '2026-07-29', note: 'Verified: email→Gmail API, button-only sending, RLS posture corrected' } },
        { id: 'smo-overview', title: 'Plain-Language Overview', type: 'html', file: 'smo-plain-overview.html', note: 'Non-technical explainer of how the platform works', review: { status: 'current', reviewedOn: '2026-07-29', note: 'Verified: button-only sending model, RLS posture corrected' } },
