  ...
  projects: [
    ...
    // ── SMD ──────────────────────────────────────────────────────────────────
    {
      ...
      docCoverage: {
        ...
        deploy:       { status: 'partial', note: 'SRC_FILES/obfuscation gotcha now written up in architecture §1.1; still no standalone release runbook' },
        ops:          { status: 'missing' },
        backup:       { status: 'partial', note: 'covered in architecture §7 (backup.js/storage-backup.js/scheduled tasks); no standalone doc' },
