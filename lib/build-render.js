...
function renderHealth(services, incidents, user) {
...
<body>
  <div class="top"><div class="t">S-Move Technologies<small>Deploy health</small></div>
    <div class="r"><span>${esc(user || '')}</span><a class="logout" href="/build">&larr; Dashboard</a></div></div>
  <article class="h-wrap">
    ...
    <div class="h-sec">Downtime log</div>
    ${rows
...
module.exports = { renderDashboard, renderLogin, renderNotApproved, renderEnrolled, renderDevices, renderChangePassword, renderDocPage, renderTeamSetup, renderBrandLibrary, renderHealth };
